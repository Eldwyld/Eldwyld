...
<title>The Witch's Almanac — The Eldwyld Archives</title>
<link rel="stylesheet" href="../../forager-grimoire/src/fonts/fonts-local.css">
<style>{css}</style>
</head><body>
"""
FOOT = "</body></html>\n"
...
def render_pdf(edition: str):
    ...
    pdf = DIST / f"The-Witchs-Almanac-{edition.upper() if edition == 'a4' else edition.capitalize()}.pdf"
...
def render_pngs(pages: list[int] | None = None, scale: float = 2.0):
    ...
    pdf_path = DIST / "The-Witchs-Almanac-Letter.pdf"
